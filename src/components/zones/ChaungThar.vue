                    ...
                    <div class="famous-card-wrap">
                        <div class="famous-card" data-card="UI/UX">
                            <div class="card-content z-index">
                                <img src="@/assets/images/zones/famous-chaungthar-01.jpg" class="famous-icon" alt="" />
                ...
                <div class="col-lg-4 famous-card-wrap">
                    <div class="famous-card-wrap">
                        <div class="famous-card" data-card="Code">
                            <div class="card-content z-index">
                                <img src="@/assets/images/zones/famous-chaungthar-02.jpg" class="famous-icon" alt="" />
                                <h3 class="title-sm">Camp Tour</h3>
                                <p class="text">
                ...
                <div class="col-lg-4 famous-card-wrap">
                    <div class="famous-card-wrap">
                        <div class="famous-card" data-card="App">
                            <div class="card-content z-index">
                                <img src="@/assets/images/zones/famous-chaungthar-03.jpg" class="famous-icon" alt="" />
                                <h3 class="title-sm">White Sand Island</h3>
                                <p class="text">
