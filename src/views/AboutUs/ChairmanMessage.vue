<template>
  <section class="header">
    ...
    <div class="content">
      ...
      <h3>
        <p>မြန်မာနိုင်ငံဟိုတယ်ဆိုင်ရာလုပ်ငန်းရှင်များအသင်း၏ မိတ်ဆက်ခြင်း</p>
      </h3>
    </div>
  </section>
  <!--- End Header and Menu --->
    ...
    <div class="container">
      <div class="about-col">
        ...
        <p>
          ...
          achieved during the past good years of tourism development in Myanmar.
        </p>
        <p>
        ...
        <p>
          ...
          members and conducts Hospitality Training Programs for the responsible
          development of the industry and involves pro-actively in CSR
          activities.
        </p>
        <p>
        ...
        <p>MHA is an active member of Myanmar Tourism Federation.</p>
        <p>
          MHA is proudly represented in International Travel Trade Fairs and
          national events to highlight our tourism and hospitality activities
