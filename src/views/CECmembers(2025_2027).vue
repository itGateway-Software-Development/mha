  ...
  <section class="cec services cec-section" id="services">
    <div class="container-fluid container-lg">
      <h4 class="mt-5 mb-5 text-center">
        Myanmar Hotelier Association (2025-2027) CEC Members
      </h4>
      <div class="row cec-cards">
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="UI/UX">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/1.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/2.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/3.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/4.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="UI/UX">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/5.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/6.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/7.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/8.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="UI/UX">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/9.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/10.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/11.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/12.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/13.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/14.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/15.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/16.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/17.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/18.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/19.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/20.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/21.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/22.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/23.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/24.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/25.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/26.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/28.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/29.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/30.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/31.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/32.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/33.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="App">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/34.jpg"
                class="cec-icon"
                alt=""
              />
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 col-sm-12 cec-card-wrap">
          <div class="cec-card" data-card="Code">
            <div class="card-content z-index">
              <img
                src="@/assets/images/CEC-Member-Photo/2025-2027/35.jpg"
                class="cec-icon"
                alt=""
              />
